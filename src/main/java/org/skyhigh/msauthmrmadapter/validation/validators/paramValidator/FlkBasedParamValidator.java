...
public class FlkBasedParamValidator {
    ...
    public void validate(Object param, String parameterName, ApiValidationType validationType, List<String> activeFlkList) {
        if (param == null)
            throw new ValidationException("Passed param is null");
        Class<?> clazz = param.getClass();
        flkValidator.validate(param, clazz, parameterName, validationType, activeFlkList);
    }
}
